...
$body$কখনো সরাসরি পিছন থেকে ঘোড়া বা গরুর কাছে যাবেন না — এটি প্রাথমিক লাথির জায়গা। সর্বদা সামনে বা কাঁধের কাছ থেকে, কোণে এবং শান্তভাবে কথা বলতে বলতে যান যাতে পশু বুঝতে পারে আপনি সেখানে আছেন। ঘোড়ার জন্য: নেতৃত্ব দেওয়া বা কাজ করার সময় বাম দিকে (কাছের দিকে) দাঁড়ান। যখন ঘরে প্রবেশ করবেন, দরজা খুলুন, প্রথমে কথা বলুন, ঘোড়াকে দেখতে দিন, তারপর প্রবেশ করুন। হ্যালটার ফিটিং: নাকের বন্ধন গালের হাড়ের ২ আঙুল নিচে থাকা উচিত। সীসার দড়ি: ক্লিপ থেকে ৩০-৪৫ সেমি ধরুন, কখনো হাতের চারপাশে মুড়বেন না।$body$,
'published'
FROM acharya_cowherd.crs_sections s
JOIN acharya_cowherd.crs_modules m ON s.module_id = m.id
WHERE m.slug='M10-safety' AND s.slug='M10-S1'
...
$body$कभी भी सीधे पीछे से घोड़े या गाय के पास न जाएं — यह प्राथमिक लात क्षेत्र है। हमेशा सामने या कंधे के पास से, एक कोण पर, शांति से बात करते हुए जाएं। घोड़े के लिए: नेतृत्व करते या काम करते समय बाईं (पास की) तरफ खड़े हों। स्टॉल में प्रवेश करते समय: दरवाजा खोलें, पहले बोलें, घोड़े को देखने दें, फिर अंदर जाएं। हॉल्टर फिटिंग: नाक का पट्टा गाल की हड्डी से 2 उंगली नीचे। लीड रोप: क्लिप से 30-45 सेमी पकड़ें, कभी हाथ के चारों ओर न लपेटें।$body$,
'published'
FROM acharya_cowherd.crs_sections s
JOIN acharya_cowherd.crs_modules m ON s.module_id = m.id
WHERE m.slug='M10-safety' AND s.slug='M10-S1'
...
$body$The cattle crush (chute) is a metal or wooden restraint device for immobilizing cattle during treatment, vaccination, or examination. Always ensure the crush is on flat, stable ground before use. Open the head gate and tail gate before the animal enters. Guide the animal in calmly — never force or chase. Once in position, close the head gate first, then the body restraint. Keep the animal calm — covering its eyes reduces stress. During any procedure with a confined animal, position yourself to the side of the head — not in front where the animal can break out and strike you. Emergency escape: know where the quick-release lever is on your crush before every use. If an animal goes down inside the crush, open the side door immediately and support the animal to prevent suffocation. Always work with a second person when using the crush.$body$,
'published'
FROM acharya_cowherd.crs_sections s
JOIN acharya_cowherd.crs_modules m ON s.module_id = m.id
