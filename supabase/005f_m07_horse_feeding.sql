...
$body$घास शुष्क वजन के अनुसार घोड़े के आहार का 60-70% होनी चाहिए — दैनिक शरीर के वजन का कम से कम 1.5% चारा। 500 किग्रा घोड़े को प्रतिदिन कम से कम 7.5 किग्रा घास चाहिए। घोड़े लगातार थोड़ा-थोड़ा खाते हैं — 4-6 घंटे से अधिक खाली पेट रहने से गैस्ट्रिक अल्सर का खतरा। सांद्र (दाना, दाना चारा) काम करने वाले घोड़ों के लिए अतिरिक्त ऊर्जा देता है — अधिकतम दिन में 2 बार, कभी एक बड़ा भोजन नहीं। कोलिक का सबसे बड़ा कारण चारे में अचानक बदलाव है। कोई भी नया चारा 7-10 दिनों में धीरे-धीरे पेश करें।$body$,
'published'
FROM acharya_cowherd.crs_sections s
JOIN acharya_cowherd.crs_modules m ON s.module_id = m.id
WHERE m.slug='M07-horse-feeding' AND s.slug='M07-S1'
