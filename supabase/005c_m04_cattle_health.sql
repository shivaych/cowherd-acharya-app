...
$body$Foot and Mouth Disease (FMD): Highly contagious viral disease. Signs — blisters on tongue, gums, feet, between toes, teats, drooling, lameness, reduced milk. No cure — treat symptoms, isolate immediately, disinfect shed, report to vet. Vaccinate all cattle every 6 months. Hemorrhagic Septicemia (HS): Bacterial (Pasteurella). Signs — sudden high fever (104-106°F), difficulty breathing, swelling under jaw and brisket, animal may die within 24 hours. Vaccinate before monsoon season. Treat with antibiotics only under vet direction. Black Quarter (BQ): Soil-borne bacterial disease. Affects young cattle 6 months to 2 years. Signs — sudden lameness, hot painful swelling of thigh or shoulder muscle, crackling sound when pressed (gas gangrene), animal may die within 12-24 hours. Vaccinate annually before monsoon.$body$,
'published'
