    ...
    <div className="min-h-screen bg-paper flex flex-col">
      ...
      <div className="bg-forest-deep text-cream px-6 pt-12 pb-14 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <h1 className="font-serif italic text-4xl lg:text-5xl mt-5 leading-tight">Cowherd Acharya</h1>
          <p className="font-mono text-[10px] tracking-[0.22em] uppercase text-gold mt-3">
            KarmYog Vatika · Internal · v1.1
          </p>
          <p className="text-cream/70 text-sm mt-3 max-w-md">
            Sales &amp; Service training playbook · Bengali, Hindi, English
          </p>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-4 lg:gap-6">
          ...
          <Card tone="cream" padding="lg" className="shadow-sm lg:col-span-2">
            <Tag tone="forest" filled className="mb-3">
              {lang === 'bn' ? 'গোপাল কে' : lang === 'hi' ? 'गोपाल कौन' : 'Who is Gopal'}
            </Tag>
            <p className="font-serif text-[15px] lg:text-[17px] leading-[1.65] text-ink">
              {lang === 'bn' ? (
                <>আমি <em>গোপাল</em> — KarmYog Vatika-র বিক্রয় ও পরিষেবা দলের জন্য তোমার প্রশিক্ষক। তুমি যদি Vatika-র সেলস বা সার্ভিস দলে যোগ দিয়েছো — অথবা OmniDEL প্ল্যাটফর্মে — এই প্লেবুক তোমার প্রথম সপ্তাহের সঙ্গী।</>
              ) : lang === 'hi' ? (
                <>मैं <em>गोपाल</em> — KarmYog Vatika की सेल्स और सर्विस टीम के लिए तुम्हारा ट्रेनर। अगर तुम Vatika की सेल्स या सर्विस टीम में जुड़े हो — या OmniDEL प्लेटफ़ॉर्म पर — यह प्लेबुक तुम्हारे पहले हफ़्ते का साथी है।</>
              ) : (
                <>I am <em>Gopal</em> — your trainer for the KarmYog Vatika Sales &amp; Service team. If you have joined the KarmYog Vatika Sales/Service team — or the broader OmniDEL platform — this playbook is your week-one companion.</>
              )}
            </p>
          </Card>
          ...
          <Card tone="paper" padding="lg" className="shadow-sm">
            ...
            <div className="space-y-2">
              ...
              <TabExplain icon="chat"
                ...
                desc={lang === 'bn' ? 'গোপালকে কথা বলো · MCQ পরীক্ষা · মাঠের প্রয়োগ' : lang === 'hi' ? 'गोपाल से बातें · MCQ परीक्षा · मैदान अभ्यास' : 'Chat with Gopal · MCQ quiz · Field debrief'} />
          ...
          <Card tone="paper" padding="lg" className="shadow-sm">
            ...
            <p className="text-[10px] text-muted text-center mt-4">
              {lang === 'bn' ? 'আটকে গেলে, Ask-এ গিয়ে গোপালকে জিজ্ঞেস করো — ২৪×৭।' : lang === 'hi' ? 'कहीं अटक जाओ तो Ask में गोपाल से पूछो — 24×7।' : "If you're stuck anywhere, go to the Ask tab and ask Gopal — 24×7."}
            </p>
          </Card>
