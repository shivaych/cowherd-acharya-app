      ...
      <div className="max-w-5xl mx-auto px-6 py-10 space-y-12">
        ...
        <section className="bg-forest/5 border-2 border-forest rounded-2xl p-6 md:p-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-sm text-stone-600 leading-relaxed mb-3">
                Replaced all raw <code className="bg-sage/50 px-1 rounded text-xs">fetch()</code> calls to the Gemini API with the official Vercel AI SDK.
                Two key changes:
              </p>
        ...
        <Section title="Technology Stack">
          <div className="space-y-3">
            ...
            <StackCard
              layer="AI — Chat"
              tech="Gemini 2.5 Flash via Vercel AI SDK"
              detail="streamText() from @ai-sdk/google. System prompt covering all 9 compulsory NOS + 6 electives. Gopal (Cowherd Acharya) persona: warm, patient, field-focused. No markdown output (responses convert to speech). Model-portable — swap provider in one line."
            />
            <StackCard
              layer="AI — Quiz"
              tech="Gemini 2.0 Flash via Vercel AI SDK + Zod"
