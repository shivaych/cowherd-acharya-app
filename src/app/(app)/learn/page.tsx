    ...
    <div className="max-w-5xl mx-auto px-4 lg:px-6 py-5">
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description={
            lang === 'bn'
              ? 'অন্য মডিউল বাছো, অথবা Ask ট্যাবে গিয়ে গোপালকে এই বিষয়ে প্রশ্ন করো।'
              : lang === 'hi'
              ? 'दूसरा मॉड्यूल चुनो, या Ask टैब में गोपाल से इस विषय पर सवाल करो।'
              : 'Pick another module, or head to the Ask tab and ask Gopal about this topic directly.'
          }
        />
      )}
    </div>
