...
const prompts = {
  bn: {
    ...
    cancel: 'বাতিল',
    thinking: 'গোপাল ভাবছে...',
    finalizing: 'গোপাল মূল্যায়ন করছে...',
    speaking: 'গোপাল বলছে...',
    score: 'প্রয়োগ স্কোর',
    feedback: 'গোপালের মূল্যায়ন',
    ...
    finishNote: 'যখন সব বলা হয়ে যাবে, "সম্পূর্ণ জমা দাও" চাপো — গোপাল স্কোর দেবে।',
    examples: [
  ...
  hi: {
    ...
    cancel: 'रद्द',
    thinking: 'गोपाल सोच रहा है...',
    finalizing: 'गोपाल मूल्यांकन कर रहा है...',
    speaking: 'गोपाल बोल रहा है...',
    score: 'अभ्यास स्कोर',
    feedback: 'गोपाल का मूल्यांकन',
    nextStep: 'अगला क़दम',
    again: 'नई रिपोर्ट',
    ...
    finishNote: 'जब सब बता दो, "पूरी प्रगति जमा करो" दबाओ — गोपाल स्कोर देगा।',
    examples: [
  ...
  en: {
    ...
    cancel: 'Cancel',
    thinking: 'Gopal is thinking...',
    finalizing: 'Gopal is evaluating...',
    speaking: 'Gopal is speaking...',
    score: 'Application Score',
    feedback: "Gopal's Evaluation",
    nextStep: 'Next Step',
    again: 'New report',
    ...
    finishNote: 'When you\'ve said everything, tap "Submit progress" — Gopal will give a score.',
    examples: [
...
export default function ApplyPage() {
  ...
  async function playGopalReply(text: string) {
...
Write all four fields in the learner's language.`;
    ...
    try {
      ...
      playGopalReply(`${parsed.summary}. ${parsed.feedback} ${parsed.nextStep}`);
    } catch (err) {
      setState('conversation');
      setError(err instanceof ApiError ? errorCopy(err, lang) : errorCopy(err, lang));
    }
      ...
      <div className="h-full flex flex-col items-center justify-center text-center px-6 text-muted">
        ...
        <p className="font-serif italic text-[15px] text-ink max-w-xs">
          {lang === 'bn'
            ...
            : 'Tell Gopal what you did today — photo, voice, or text.'}
        </p>
