      ...
      <Card tone="forest" padding="lg" className="relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <p className="text-cream/80 text-sm mt-2 max-w-md">
            {lang === 'bn'
              ? 'আজ গোপালের সাথে কী শিখবে?'
              : lang === 'hi'
              ? 'आज गोपाल के साथ क्या सीखोगे?'
              : 'What will you learn with Gopal today?'}
          </p>
        </div>
      </Card>
      ...
      <div className="grid lg:grid-cols-3 gap-5">
        ...
        <section className="lg:col-span-2 space-y-2.5">
          ...
          <BriefLink
            ...
            title={t('ask', lang)}
            desc={lang === 'bn'
              ? 'গোপালের সাথে চ্যাট · কথা বা লিখে প্রশ্ন'
              : lang === 'hi'
              ? 'गोपाल से चैट · बोलकर या लिखकर सवाल'
              : 'Chat with Gopal · voice or text'}
          />
          <BriefLink
            href="/apply"
            icon="hand"
