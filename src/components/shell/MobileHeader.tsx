...
const HINT_KEY = "cowherd-menu-hint-seen";
        ...
        <div className="flex items-center justify-between px-4 py-2.5">
          <Link href="/" className="flex items-center gap-2.5 min-w-0" aria-label="Home">
            ...
            <div className="leading-tight min-w-0">
              <div className="font-serif italic text-base text-ink truncate">Gopal</div>
              <div className="font-mono text-[8px] tracking-[0.18em] uppercase text-muted truncate">
                {currentLabel || "KarmYog Vatika"}
              </div>
            </div>
          </Link>
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-line">
              <div className="flex items-center gap-2.5">
                ...
                <div className="leading-tight">
                  <div className="font-serif italic text-sm text-ink">Cowherd Acharya</div>
