...
const copy = {
  bn: { hold: "ধরে বলো", listen: "শুনছি...", speak: "গোপাল বলছে...", connect: "জোড়া লাগছে...", close: "বন্ধ" },
  hi: { hold: "दबाकर बोलो", listen: "सुन रहा हूँ...", speak: "गोपाल बोल रहा है...", connect: "जुड़ रहा है...", close: "बंद" },
  en: { hold: "Hold to talk", listen: "Listening...", speak: "Gopal is speaking...", connect: "Connecting...", close: "Close" },
} as const;
